...
class NudgeEnv(NudgeBaseEnv):
    ...
    def __init__(self, mode: str, plusplus=False, noise=False):
        ...
        self.env = gymnasium.make("getout", disable_env_checker=True)  # FIXME
    ...
    def extract_logic_state(self, raw_state):
        ...
        for entity in representation["entities"]:
            # print('entity:', entity[0].name, entity[1:3])
            ...
            elif entity[0].name == 'COIN':
                # print('entity: COIN', entity[1:3])
                logic_state[4][4] = 1
                logic_state[4][-2:] = entity[1:3]
            
            elif entity[0].name == 'COIN2':
                # print('entity: Coin2', entity[1:3])
                logic_state[5][4] = 1
                logic_state[5][-2:] = entity[1:3]

            elif entity[0].name == 'FLAG':
                # print('entity: Coin2', entity[1:3])
                logic_state[6][5] = 1
...
def sample_to_model_input(sample, no_dict=False, include_score=False):
    ...
    # print('state', state['level'],tr_entity, swap_coins)
    tr_state = {
        'base': np.array([
            0,
            0,
...
def fixed_size_entity_representation(state, swap_coins=None):
    ...
    for entity in entities:
        # FIXME 
        # I comment this section out because I don't know what it does
